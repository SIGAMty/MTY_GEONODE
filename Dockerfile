...
RUN mkdir -p /usr/src/mty_geonode
...
COPY src /usr/src/mty_geonode/
WORKDIR /usr/src/mty_geonode
...
RUN chmod +x /usr/src/mty_geonode/tasks.py \
    && chmod +x /usr/src/mty_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/mty_geonode/entrypoint.sh
